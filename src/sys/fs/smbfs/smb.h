...
int smb_request(struct smb_share *share, struct smb *smb, unsigned char cmd, int params, char *data, int datasize,
                int retry);
...
int
smb_get_connection(struct smb_share *share, struct ip_addr *ipaddr, unsigned short port, char *domain, char *username,
                   char *password);
